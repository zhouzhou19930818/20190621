...
export default class SliderChart extends React.Component {
    ...
    componentDidMount() {
        ...
        this.mouseEvent(MARKLEFT, this.resizeLeft, this.resizeLeftListener);
        this.mouseEvent(MARKRIGHT, this.resizeRight, this.resizeRightListener);
        this.mouseEvent(MARKBLOCK, this.slideBlock, this.moveBlockListener);
    ...
    componentWillUnmount() {
        ...
        this.resizeLeft.removeEventListener("touchstart", this['touchstart' + MARKLEFT]);
        this.resizeLeft.removeEventListener("mousedown", this['mousedown' + MARKLEFT]);
        this.resizeRight.removeEventListener("touchstart", this['touchstart' + MARKRIGHT]);
        this.resizeRight.removeEventListener("mousedown", this['mousedown' + MARKRIGHT]);
        this.slideBlock.removeEventListener("touchstart", this['touchstart' + MARKBLOCK]);
        this.slideBlock.removeEventListener("mousedown", this['mousedown' + MARKBLOCK]);
        window.removeEventListener("touchmove", this['mousemove' + MARKLEFT]);
        window.removeEventListener("touchmove", this['mousemove' + MARKRIGHT]);
        window.removeEventListener("touchmove", this['mousemove' + MARKBLOCK]);
        window.removeEventListener("mousemove", this['mousemove' + MARKLEFT]);
        window.removeEventListener("mousemove", this['mousemove' + MARKRIGHT]);
        window.removeEventListener("mousemove", this['mousemove' + MARKBLOCK]);
        window.removeEventListener("touchend", this['mouseup' + MARKLEFT]);
        window.removeEventListener("touchend", this['mouseup' + MARKRIGHT]);
        window.removeEventListener("touchend", this['mouseup' + MARKBLOCK]);
        window.removeEventListener("mouseup", this['mouseup' + MARKLEFT]);
        window.removeEventListener("mouseup", this['mouseup' + MARKRIGHT]);
        window.removeEventListener("mouseup", this['mouseup' + MARKBLOCK]);
    }
    ...
    // mouse events
    mouseEvent = (mark, targetEl, callback) => {
        ...
        this['mousedown' + mark] = (event) => {
            isDown = true;
            x = event.clientX;
            movingId = event.target.id;
        };

        this['mousemove' + mark] = (event) => {
        ...
        // 鼠标按下方块
        targetEl.addEventListener("touchstart", this['mousedown' + mark]);
        targetEl.addEventListener("mousedown", this['mousedown' + mark]);
        // 拖动
        window.addEventListener("touchmove", this['mousemove' + mark]);
        window.addEventListener("mousemove", this['mousemove' + mark]);
        // 鼠标松开
        window.addEventListener("touchend", this['mouseup' + mark]);
        window.addEventListener("mouseup", this['mouseup' + mark]);
    };
