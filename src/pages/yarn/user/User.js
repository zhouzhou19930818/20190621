    ...
    getMemoryCpuTrend = ({ cluster, startTime, endTime } = {}) => {
        ...
        api.getUserCpuAndMemoryTrend({
            ...
            .then(res => {
                ...
                const data = response.data || [];
                this.memoryCpuData = data.users.reverse() || [];
                ...
                this.memoryCpuData.forEach((item, i) => {
                    ...
                    memorySeries.push(getSeries(i, item.userName, memoryData, true));
                    cpuSeries.push(getSeries(i, item.userName, cpuData, true));
                });
